...
\def\B{\ifmmode\mathopen{\.{@\{}}\else\Bm\mathopen{\.{@\{}}\Bm\fi} % begin controlled comment
...
\def\H#1{\hbox{[\.{#1}]}}  % hexadecimal constant
\let\I=\ne % unequal sign
...
\def\T{\ifmmode\mathclose{\.{@\}}}\else\Bm\mathclose{\.{@\}}}\Bm\fi} % terminate controlled comment
...
% German version must use A4 paper --- John Evans (11/2/95)

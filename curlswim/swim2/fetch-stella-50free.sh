#!/usr/bin/env bash
# Fetches Stella Julianna Evans' 50 Freestyle SCY times from the USA Swimming data hub.
# Requires: curl, jq
...
# Step 2: Fetch her 50 Freestyle SCY times from the USA Swimming Times Elasticube.
    ...
    \"metadata\": [
      ...
      },
      {
        \"jaql\": {
          ...
          \"title\": \"Event\", \"filter\": {\"equals\": \"50 FR SCY\"}
        },
        \"panel\": \"scope\"
      },
      {
...
echo "50 Freestyle SCY — all times (fastest first):"
echo "----------------------------------------------"
printf "%-10s  %s\n" "Time" "Meet"

...
\begin{description}[style=nextline]
  ...
  \item[\req{REQ-F-11}] When no swimmer keyword is supplied to
        ...
        the program shall process all four swimmers.
  \item[\req{REQ-F-12}] The set of selectable swimmers shall be
        ...
        and Keith Santiago Evans (\code{keith}).
\end{description}
...
\begin{description}[style=nextline]
  \item[\req{REQ-P-01}] A full refresh of all four swimmers
        across all thirty-one default events
        ($4 \times (1 + 31) = 128$ HTTP requests) shall complete
...
\begin{longtable}{ll}
  ...
  REQ-F-10 \ldots REQ-F-12 & Demonstration \\
  ...
  REQ-P-01, REQ-P-02       & Demonstration (timed) \\
